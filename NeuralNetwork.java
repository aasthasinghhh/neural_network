...
abstract public class NeuralNetwork {
	...
	public InputUnit getInputUnit(int i) {
		return this.getInputUnits()[i];
	}
	
	public NeuronUnit getOutputUnit(int i) {
		return this.getOutputUnits()[i];
	}
	
	public void setInput(int i, double xi) {
		this.getInputUnit(i).setOutput(xi);
	}

	public double getOutput(int i) {
		return this.getOutputUnit(i).getOutput();
	}
